...
cats_and_owners.push({name:'Taylor Swfit',cat:'Meredith'})
...
nobel_prize_winners_2017.prizes[3].laureates[0].firstname
...
let laureatewinners=0;
nobel_prize_winners_2017.prizes.forEach(function (Prize){
    Prize.laureates.forEach(function (winners){
        laureatewinners++
    })
})

console.log(laureatewinners)
// let prizes =0;
// let prizesList= prizes.list
// console.log(prizesList)
//
// let prizeinfo=prizesList[0]
// console.log(prizeinfo)
//
// let category =prizeinfo.category
